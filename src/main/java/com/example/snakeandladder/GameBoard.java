...
public class GameBoard {
    ...
    static  int width=10;
    static ArrayList<Pair<Integer,Integer>> positionCoordinates=new ArrayList<>();
   ...
   public GameBoard(){
    ...
    public int playerPositionAtSnakeOrLdder(int piecePosition){
